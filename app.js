...
class App extends Homey.App {
    async onInit() {
        ...
        if (process.env.DEBUG === '1' || runningVersion.patch % 2 != 0) {
            // either when running from console or odd patch version
            await LogToFile();
        ...
        this.log(
            'app.js                     preparing logging environment done'
        );
        ...
        let logLine =
            ' app.js || onInit || --------- ' +
            `${Homey.manifest.id} ${Homey.manifest.version} started ---------`;
